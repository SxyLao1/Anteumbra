...
TEMPORARY_APPLICATION_TO_INFRASTRUCTURE = {
    ...
    ("application/runtime_plugins.py", "anteumbra.infrastructure.monitoring.notifier"),
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.log_analyzer"),
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.log_monitor"),
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.monitor"),
...
TEMPORARY_APPLICATION_TO_INFRASTRUCTURE_RATIONALES = {
    ...
    ("application/runtime_plugins.py", "anteumbra.infrastructure.monitoring.notifier"): "inject plugin formatter",
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.log_analyzer"): "inject worker analyzer factory",
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.log_monitor"): "inject log monitor factory",
    ("application/runtime_workers.py", "anteumbra.infrastructure.monitoring.monitor"): "inject site monitor factory",
