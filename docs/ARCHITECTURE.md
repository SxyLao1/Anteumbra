...
pm.emit("memory_shell_found", ...) ─→  (no built-in handler; published for
                                        external plugins and alert surfaces)
...
| `memory_shell_found` | memory_shell_probe | — (published for external plugins) |
